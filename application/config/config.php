...
|
*/
// $config['base_url'] = 'http://localhost/idealtech/';

// dynamically set base_url
if (isset($_SERVER['HTTP_HOST'])) {
    $base_url = (isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) === 'on' ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
} else {
    $base_url = 'http://localhost/idealtech/';
}
...
|
*/
$config['encryption_key'] = 'anytexthere';
...
$config['sess_expiration'] = 86400; // 24 hours (was 7200 = 2 hours)
$config['sess_save_path'] = APPPATH . 'cache/sessions/';
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 1800; // 30 minutes (was 300 = 5 minutes)
