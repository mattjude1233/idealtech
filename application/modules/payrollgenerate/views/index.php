        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <div class="float-sm-right">
                    <a href="javascript:;" class="btn btn-pill btn-primary btn-md text-white show_payslip-btn">
                        <i class="fa fa-file m-r-5"></i> Show Payslip
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <?php if (!empty($employee)) : ?>
                                    <?php foreach ($employee as $emp) : ?>
                                        <tr data-hid="<?= $this->mysecurity->encrypt_url($emp['id']); ?>">
                                            ...
                                            <td><a href="<?= base_url('employee/profile/' . $this->mysecurity->encrypt_url($emp['id'])) ?>" class="d-block" target="_blank"> <?= "{$emp['emp_lname']}, {$emp['emp_fname']}" ?> </a></td>

                                            <td><?= $emp['emp_id'] ?></td>
                                            <td><?= users__lang('level', $emp['emp_level']) ?></td>
                                            <td>
                                                <a href="javascript:;" class="btn btn-sm <?= !empty($emp['payroll_id']) ? "btn-success" : "btn-default" ?> payroll_slip-btn"><i class="fa fa-file m-r-5"></i> Payroll Slip</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else : ?>
